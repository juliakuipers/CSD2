...
SampleShaper::SampleShaper(float freq, float samplerate) :
Effect(freq,samplerate),
...
float SampleShaper::calculateM(float sample)
{
  sample += 1;
...
float SampleShaper::calculateL(float sample)
{
  return 0;
}

float SampleShaper::calculateR(float sample)
{
  return 0;
}
